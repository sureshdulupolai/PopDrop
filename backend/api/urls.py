...
from .views import (
    SignupView, LoginView, ProfileView, VerifyOtpView, ResendOtpView, 
    UserDetailView, UserListView, ReviewDeleteView, ReviewListCreateView, 
    TeamMemberPublicListView, TeamMemberCreateView, TeamMemberDetailView, 
    TeamApplicationView, ContactRequestView, ForgotPasswordView, ResetPasswordView
)
